...
function RegisterForm() {
  ...
  return (
    <div
      className="contianer shadow p-2 bg-light text-warning"
      style={{ maxWidth: 700, margin: "auto", marginTop: 30 }}
    >
      <TextHead title="Register form" color="text-warning" />
      <form className="m-5" onSubmit={(e) => submitHandle(e)}>
        ...
        <Input
          ...
          must
        />
        <Button name="Login" type="submit" styling=" btn btn-warning" />
      </form>
    </div>
  );
}
